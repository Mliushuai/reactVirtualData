                            ...
                            <div  style={{display: this.state.showMin === true ? "block" : "none"}}>
                                {
                                    dataSource.map((item, index) => {
                                        return <div
                                            ...
                                            className="LeftTitle"
                                        >
                                            <span style={{width: "50%", textAlign: "left", cursor: "pointer",lineHeight:"45px",paddingLeft:"20px"}}
                                                  onClick={this.ListSource.bind(this, item.key)}>{item.title}</span><span
                                            style={{display:"block",width: "50%", float:"right",lineHeight:"45px",textAlign:"right",paddingRight:"20px"}}>{item.name}</span>
